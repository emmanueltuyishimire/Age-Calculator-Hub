...
const ScientificCalculator = () => {
  ...
  return (
    <div className="bg-slate-700 dark:bg-slate-800 border-4 border-slate-600 dark:border-slate-700 rounded-xl p-2 w-full mx-auto shadow-2xl max-w-sm sm:max-w-[42rem]">
