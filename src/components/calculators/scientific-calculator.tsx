...
const ScientificCalculator = () => {
  ...
  const renderButton = (config: { label: React.ReactNode, value: string, style?: string }) => (
      <Button
          ...
          className={cn("h-8 text-xs p-1 shadow-md hover:shadow-sm active:shadow-inner active:translate-y-px", config.style, {
  ...
  return (
    <div className="bg-slate-700 dark:bg-slate-800 border-4 border-slate-600 dark:border-slate-700 rounded-xl p-2 sm:p-3 w-full mx-auto shadow-2xl max-w-sm sm:max-w-md md:max-w-[820px]">
