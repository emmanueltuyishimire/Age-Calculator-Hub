...
const ScientificCalculator = () => {
  ...
  return (
    <div className="bg-slate-700 dark:bg-slate-800 border-4 border-slate-600 dark:border-slate-700 rounded-xl p-2 sm:p-3 w-full mx-auto shadow-2xl max-w-md">
      <div className="bg-emerald-100/10 dark:bg-black/20 rounded p-2 mb-2 border-2 border-slate-800 dark:border-black shadow-inner">
       ...
       <div className="grid grid-cols-10 gap-1.5">
        <div className="col-span-5 grid grid-cols-5 gap-1.5 p-1 rounded-lg bg-slate-600/20 dark:bg-black/20">
