  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="max-w-5xl mx-auto">
            ...
            <section className="mt-12 space-y-8 animate-fade-in">
                <Card>
                    ...
                    <CardContent>
                        <ul className="list-disc list-inside space-y-2 text-muted-foreground">
                            <li><Link href="/savings-calculator" className="text-primary hover:underline">Savings Calculator</Link></li>
                ...
                <Card>
                    ...
                    <CardContent className="space-y-4 text-muted-foreground">
                        ...
                        <p>The gains from CDs are taxable as income in the U.S. unless they are in accounts that are tax-deferred or tax-free, such as an <Link href="/ira-calculator" className="text-primary hover:underline">IRA</Link> or <Link href="/roth-ira-calculator" className="text-primary hover:underline">Roth IRA</Link>.</p>
                    </CardContent>
                </Card>
        ...
        <RelatedCalculators currentCategory="Investment" currentHref="/cd-calculator" />
      </div>
    </div>
  );
}
