...
const faqs = [
    ...
    { question: "What is corrected age for a premature baby?", answer: "Corrected age (or adjusted age) is your baby's chronological age minus the number of weeks they were born early. For example, a 6-month-old baby who was born 2 months (8 weeks) early has a corrected age of 4 months. Doctors use corrected age to assess a preterm baby's development." },
    { question: "Do you use corrected age for a baby born at 37 weeks?", answer: "A baby born at 37 weeks is considered 'early term', not premature (which is before 37 weeks). Therefore, corrected age is usually not necessary. However, always follow your pediatrician’s guidance on developmental milestones." },
