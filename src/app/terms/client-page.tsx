    ...
    return (
        <div className="container mx-auto px-4 py-8">
            <main role="main" className="max-w-4xl mx-auto">
                ...
                <p className="lead">
                    Please read these Terms of Service ("Terms", "Terms of Service") carefully before using the https://innerpeacejournals.com website (the "Service") operated by Age Calculator Hub ("us", "we", or "our").
                </p>
                <p>
                ...
                <p>
                    Age Calculator Hub provides a collection of online calculators and informational articles for general informational and educational purposes only. You agree to use the Service in compliance with all applicable laws and regulations and not for any purpose that is unlawful or prohibited by these Terms.
                </p>
                <p>
                ...
                <p>
                    The Service and its original content, features, and functionality (including but not limited to all information, text, graphics, logos, and the calculators themselves) are and will remain the exclusive property of Age Calculator Hub and its licensors. The Service is protected by copyright, trademark, and other laws of both the United States and foreign countries. Our trademarks and trade dress may not be used in connection with any product or service without the prior written consent of Age Calculator Hub.
                </p>
                ...
                <p>
                    Our Service may contain links to third-party web sites or services that are not owned or controlled by Age Calculator Hub. We use third-party advertising, such as Google AdSense, to support our Service. These third parties may use cookies to serve ads based on a user's prior visits to our website or other websites.
                </p>
                <p>
                     Age Calculator Hub has no control over, and assumes no responsibility for, the content, privacy policies, or practices of any third-party web sites or services. You further acknowledge and agree that Age Calculator Hub shall not be responsible or liable, directly or indirectly, for any damage or loss caused or alleged to be caused by or in connection with the use of or reliance on any such content, goods, or services available on or through any such web sites or services.
                </p>
