          ...
          <Card className="my-8">
            ...
            <CardContent className="space-y-4">
                ...
                <ul className="space-y-3">
                    ...
                    <li className="flex items-start"><CheckCircle2 className="h-5 w-5 text-primary mr-3 mt-1 shrink-0" /><span><strong>Financial and Insurance Products:</strong> Life insurance premiums, annuity calculations, and retirement benefit eligibility (<Link href="/retirement" className="text-primary hover:underline">like Social Security</Link>) are all based on precise age.</span></li>
