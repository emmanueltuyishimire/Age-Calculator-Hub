...
export const metadata: Metadata = {
    title: 'Scientific & Health Calculators - BMI, BMR, Body Fat & More',
  ...
  return (
    <main className="container mx-auto px-4 py-8" role="main">
      <div className="text-center mb-12">
        <h1 className="text-3xl md:text-4xl font-bold tracking-tight mb-2">Scientific & Health Calculators</h1>
