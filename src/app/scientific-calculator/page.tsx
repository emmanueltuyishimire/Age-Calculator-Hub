                ...
                <Card>
                    ...
                    <CardContent>
                        ...
                        <ol className="list-decimal list-inside space-y-2 text-muted-foreground mt-4">
                            ...
                            <li><strong>Perform Operations:</strong> Use the standard operators (+, -, ×, ÷). The order of operations is respected.</li>
                            <li><strong>Use Scientific Functions:</strong> Before entering a number, click a function like √x (square root) or sin. For functions like xy, enter the base, click xy, then enter the exponent and press =.</li>
                            <li><strong>Toggle Modes:</strong> Use the `Deg/Rad` button to switch between degrees and radians for trigonometric calculations.</li>
                            <li><strong>Use Memory:</strong> Store numbers with `M+` and `M-`, recall with `MR`, and clear with `MC`.</li>
                        </ol>
                    </CardContent>
                </Card>
