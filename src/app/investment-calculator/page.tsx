...
export const metadata: Metadata = {
    title: 'Investment Calculator - Calculate Average Return',
    description: 'Use our free Investment Calculator to calculate your average return on investment using either cash flow analysis (IRR) or by averaging multiple investment returns.',
    alternates: {
      ...
      <div className="max-w-4xl mx-auto">
        <main role="main">
            <div className="text-center mb-8">
                <h1 className="text-3xl md:text-4xl font-bold tracking-tight mb-2">Investment & Average Return Calculator</h1>
        ...
        <RelatedCalculators currentCategory="Financial Calculators" currentHref="/investment-calculator" />
      </div>
    </div>
  );
}
