...
export const articles: Article[] = [
  ...
  },
  {
    ...
    title: 'Understanding Your Paycheck: A Guide to Deductions and Net Pay',
    description: 'Decode your pay stub. This guide explains gross vs. net pay, pre-tax and post-tax deductions, and how to make the most of your earnings.',
    category: 'Financial Planning',
    publishedDate: '2024-11-10',
  },
  {
    slug: 'creating-a-budget-that-works',
    title: 'Creating a Budget That Works: The 50/30/20 Rule and Beyond',
    description: 'A budget is a plan for your money. Learn the popular 50/30/20 rule and other simple strategies to manage your spending and accelerate your savings.',
    category: 'Financial Planning',
    publishedDate: '2024-11-11',
  },
  {
    slug: 'high-yield-savings-vs-stocks',
    title: 'High-Yield Savings vs. The Stock Market: Where to Put Your Money',
    description: 'Understand the critical difference between saving and investing. Learn when to use a safe high-yield savings account versus when to invest in the stock market for long-term growth.',
    category: 'Financial Planning',
    publishedDate: '2024-11-12',
  },
  {
    slug: 'debt-snowball-vs-avalanche',
    title: 'Debt Snowball vs. Avalanche: Which Debt Payoff Method is Best?',
    description: 'Ready to tackle your debt? This guide breaks down the two most popular payoff strategies—the behavior-focused Snowball and the math-focused Avalanche—to help you choose.',
    category: 'Financial Planning',
    publishedDate: '2024-11-13',
  },
  {
    slug: 'the-power-of-compound-interest',
    title: 'The Power of Compound Interest: Why Starting Early is Everything',
    description: 'Discover the "eighth wonder of the world." Learn how compound interest works and why time is the most important ingredient for building wealth.',
    category: 'Financial Planning',
    publishedDate: '2024-11-14',
  },
  {
    slug: 'guide-to-retirement-accounts',
    title: 'A Simple Guide to Retirement Accounts: 401(k) vs. IRA',
    description: 'Confused by 401(k)s, IRAs, and Roth accounts? This guide demystifies the most common retirement savings accounts to help you choose the right one for your future.',
    category: 'Financial Planning',
    publishedDate: '2024-11-15',
  },
  {
    slug: 'understanding-asset-allocation',
    title: 'Understanding Asset Allocation: A Key to Long-Term Investing Success',
    description: 'Learn the most important concept in investing: asset allocation. Understand how to balance stocks and bonds to manage risk and maximize long-term growth.',
    category: 'Financial Planning',
  ...
  },
   {
    ...
    description: 'Your credit score is a crucial number in your financial life. Learn the five key factors that make up your score and how you can improve it.',
    category: 'Financial Planning',
  ...
  },
  {
    ...
    description: 'An emergency fund is your financial safety net. Learn how much you need, where to keep it, and the simple steps to build one from scratch.',
    category: 'Financial Planning',
